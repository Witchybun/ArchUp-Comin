    ...
    def fill_slot_data(self) -> Dict[str, object]:
        ...
        if self.multiworld.randomize_weapons_level[self.player]:
            ...
            for name in weapons_upgrade_5_table.keys():
                if self.multiworld.per_slot_randoms[self.player].randint(0, 100) < 33:
                    value = self.multiworld.per_slot_randoms[self.player].randint(1, 5)
                    item_dictionary_copy[name] += value

            for name in weapons_upgrade_10_table.keys():
                if self.multiworld.per_slot_randoms[self.player].randint(0, 100) < 33:
                    value = self.multiworld.per_slot_randoms[self.player].randint(1, 10)
                    item_dictionary_copy[name] += value
